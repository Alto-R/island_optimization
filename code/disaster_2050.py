...
cost_df.to_csv(f'output_2050/{island_lat}_{island_lon}_best_cost.csv', index=False)
capacity_df.to_csv(f'output_2050/{island_lat}_{island_lon}_capacity.csv', index=False)
results.to_csv(f'output_2050/{island_lat}_{island_lon}_results.csv', index=False)