...
### 系统能源设备的参数 ###
# WT风电 PV光伏 WEC波浪能 EB电锅炉 AC空调 CHP热电联产机组 PEM质子交换膜电解槽 FC燃料电池 ESS电化学储能 TES热能储存 CES冷能储存 LNG液化天然气储罐 LNGV LNG气化器 H2S氢气储存      
...
cost_df.to_csv(f'output_2020/{island_lat}_{island_lon}_best_cost.csv', index=False)
capacity_df.to_csv(f'output_2020/{island_lat}_{island_lon}_capacity.csv', index=False)
results.to_csv(f'output_2020/{island_lat}_{island_lon}_results.csv', index=False)