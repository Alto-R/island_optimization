...
investment_cost = {'WT': 1392,'PV': 1377, 'WEC': 6000,'AC':150, 'EB': 250,'CHP': 1300,'PEM': 748, 'FC': 1600, 'LNG': 700,'LNGV': 500, 'ESS': 588, 
...
cost_df.to_csv(f'output_future_2050/{island_lat}_{island_lon}_best_cost.csv', index=False)
capacity_df.to_csv(f'output_future_2050/{island_lat}_{island_lon}_capacity.csv', index=False)
results.to_csv(f'output_future_2050/{island_lat}_{island_lon}_results.csv', index=False)